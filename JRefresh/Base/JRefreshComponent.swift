...
extension JRefreshComponent {
    ...
    @objc open func scrollViewContentOffsetDidChange(_: [NSKeyValueChangeKey: Any]?) {}

    /// 当scrollView的contentSize发生改变的时候调用
    @objc open func scrollViewContentSizeDidChange(_: [NSKeyValueChangeKey: Any]?) {}

    /// 当scrollView的拖拽状态发生改变的时候调用
    @objc open func scrollViewPanStateDidChange(_: [NSKeyValueChangeKey: Any]?) {}
}
